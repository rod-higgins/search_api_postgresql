...
/**
 * Functional tests for EmbeddingManagementForm.
 *
 * @group search_api_postgresql
 */
class EmbeddingManagementFormTest extends BrowserTestBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function testFormDisplay() {
    ...
    $this->assertSession()->pageTextContains('EmbeddingManagementForm');
  }
  ...
  protected function getFormPath() {
    ...
    return '/admin/config/search/search-api/postgresql/' . strtolower(str_replace('Form', '', 'EmbeddingManagementForm'));
  }
