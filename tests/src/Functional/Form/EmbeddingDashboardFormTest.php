...
/**
 * Functional tests for EmbeddingDashboardForm.
 *
 * @group search_api_postgresql
 */
class EmbeddingDashboardFormTest extends BrowserTestBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function testFormDisplay() {
    ...
    $this->assertSession()->pageTextContains('EmbeddingDashboardForm');
  }
  ...
  protected function getFormPath() {
    ...
    return '/admin/config/search/search-api/postgresql/' . strtolower(str_replace('Form', '', 'EmbeddingDashboardForm'));
  }
